...
/* @var $searchModel core\models\search\DriverCriteriaSearch */
...
$this->title = \Yii::t('app', 'Driver Criteria');
$this->params['breadcrumbs'][] = $this->title; ?>

<?= $ajaxRequest->component(true) ?>

<div class="driver-criteria-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            'personAsDriver.person.first_name',
            'personAsDriver.no_sim',
            'criteria_name',
            'type',
            [
        ...
        'rowOptions' => function ($model, $key, $index, $grid) {
            return ['id' => $model['id'], 'class' => 'row-grid-view-driver-criteria', 'style' => 'cursor: pointer;'];
        },
        'pager' => [
...
$jscript = ''
    ...
    $("div.container.body").on("click", function(event) {
        ...
        if ($(event.target).parent(".row-grid-view-driver-criteria").length > 0) {
    ...
    $(".row-grid-view-driver-criteria").popover({
        trigger: "click",
        placement: "top",
        container: ".row-grid-view-driver-criteria",
        html: true,
        selector: "td",
        content: function () {
    ...
    $(".row-grid-view-driver-criteria").on("shown.bs.popover", function(event) {
