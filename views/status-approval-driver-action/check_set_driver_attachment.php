            ...
            <div class="x_panel">
                <div class="x_content">
                    ...
                    $form = ActiveForm::begin([
                        ...
                        echo ' ' . Html::a('<i class="fa fa-pencil-alt"></i> Edit', ['registry-driver/update-driver-attachment', 'id' => $id, 'appDriverId' => $appDriverId, 'actid' => $actid, 'logsaid' => $logsaid], ['class' => 'btn btn-primary']);
                        ...
                        if (!empty($model['registryDriverAttachments'])):
                            ...
                            foreach ($model['registryDriverAttachments'] as $dataDriverAttachments): ?>
                                ...
                                <div class="col-xs-6 col-sm-3">
                                    ...
                                    <h5 class="text-center"><strong><?= $model['registryDriverAttachments'][0]['type'] ?></strong></h5>
                                </div>
