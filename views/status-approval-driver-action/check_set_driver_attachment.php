            ...
            <div class="x_panel">
                <div class="x_content">
                    ...
                    $form = ActiveForm::begin([
                        ...
                        echo ' ' . Html::a('<i class="fa fa-pencil-alt"></i> Edit', ['registry-driver-approval/update-driver-attachment', 'id' => $id, 'appDriverId' => $appDriverId, 'actid' => $actid, 'logsaid' => $logsaid], ['class' => 'btn btn-primary']);
